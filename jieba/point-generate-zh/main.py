...
def main():
    ...
    parser.add_argument("--content_len",default=200,type=int,
                       help="文章的所允许的最大长度")

    parser.add_argument("--title_len", default=40, type=int,
                        help="训练和生成时摘要所允许的最大长度")

    parser.add_argument("--min_decoder_len",default = 6,type=int,
