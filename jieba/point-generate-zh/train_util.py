...
def get_features_from_cache(cache_file):
    ...
    dataset = TensorDataset(all_encoder_input, all_encoder_mask, all_decoder_input, all_decoder_mask,all_decoder_target,all_encoder_input_with_oov,all_decoder_target_with_oov,all_oov_len)
    ...
    for epoch in epoch_iterator:
        ...
        for file_idx in file_iterator:
            ...
            for i,batch in enumerate(data_iterator):
                ...
                batch = from_feature_get_model_input(batch,hidden_dim=hidden_dim,device = device,pointer_gen = pointer_gen,use_coverage = use_coverage)
                ...
                if 0 == (forward_step % args.gradient_accumulation_steps):
                    ...
                    if 1 == update_step or 0 == update_step % args.evaluation_steps:
                        ...
                        logging.info("update step:[{}] ,save model dir[{}]".format(update_step,os.path.join(save_dir, "model.bin")))
