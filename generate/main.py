...
from model.Transformer_VAE_PG import PointerGeneratorNetworks
...
def main():
    ...
    parser.add_argument("--token_data",default='E:\\工作\\毕业论文\\LCSTS数据集\\token',type = str,
    ...
    parser.add_argument("--do_train",action='store_true',default=True,
                        help="是否进行训练")
    parser.add_argument("--do_decode", action='store_true',default=False,
                        help="是否对测试集进行测试")
    ...
    # features_50000_400_100
    feature_dir = "{}_{}_{}_{}". \
        format(args.feature_dir_prefix, model_config.vocab_size, model_config.max_content_len,
               model_config.max_title_len)
    args.feature_dir = os.path.join(".", feature_dir)
