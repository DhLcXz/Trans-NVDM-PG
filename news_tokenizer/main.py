...
def main():
    ...
    # F:\data\zh\news
    parser.add_argument("--original_data_dir",default="E:\\工作\\毕业论文\\LCSTS数据集\\dataTest",type = str,
                        help="包含文件lcsts_train.json的文件夹路径")
    # F:\data\zh\tokenized-single
    parser.add_argument("--tokenized_dir", default="E:\\工作\\毕业论文\\LCSTS数据集\\token", type=str,
                        help="分词后文件所存储的文件夹")
